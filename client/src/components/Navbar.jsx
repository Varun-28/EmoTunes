    ...
    <div className='navbar p-4'>
      <nav className='flex items-center'>
        <Link to="/" className='mr-auto'>
          <img className='logo-img w-40' src={Logo} alt='logo'/>
        </Link>
        <ul className='flex items-center gap-x-2 mr-2 text-sm md:text-lg md:mr-6 md:gap-x-4'>
          ...
          <li className='nav-link border-solid border-2 rounded-3xl border-transparent px-4 py-2'
          style={{
        ...
        <FontAwesomeIcon icon={theme.isLight ? faSun : faMoon} /></button>
      </nav>
    </div>
  )
}
