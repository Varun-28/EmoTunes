    ...
    <div>
      <section className='hero-section p-4'>
        <div className='flex flex-col gap-y-4 justify-center text-center md:text-left px-10'>
          <h1 className='text-4xl font-bold'>Let your Emotion express the music.</h1>
          <p>Offering best music worldwide. Discover and stream constantly expanding mix of music
          from artists around the world.</p>
          <button className='hero-btn px-4 py-2 mx-auto md:mx-0'
          style={{
